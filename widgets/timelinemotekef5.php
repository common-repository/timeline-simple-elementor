 ...
 * @since 1.0.0
 */
class timelinemotekef5 extends \Elementor\Widget_Base {
 
   public function get_name() {
      return 'timelinemotekef5';
   }
 
   public function get_title() {
      return esc_html__( 'time line 5', 'timeline-simple-Elementor' );
   }
   ...
   $this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} #motekef5 p' => 'border-color:{{VALUE}}',
				],
				'default' =>'#0013FF'
			]
		);
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} #motekef5 p' => 'color: {{VALUE}}',
				],
				'default' =>'#666666'
			]
		);
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} #motekef5 p:nth-child(even):before' => 'background-color: {{VALUE}}',
				],
				'default' =>'#0013FF'
			]
		);
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} #motekef5 p:nth-child(odd):before' => 'background-color: {{VALUE}}',
				],
				'default' =>'#0013FF'
			]
		);
	...
	$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}  #motekef5 p' => 'text-align:{{VALUE}}',
				],
				'default' => 'left',
  ...
  protected function render( $instance = [] ) {
    ...
    ?>
	<div id="motekef5"<?php $this->print_render_attribute_string( 'list' ); ?>>
<?php 
