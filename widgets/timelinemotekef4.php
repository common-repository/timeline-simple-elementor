 ...
 * @since 1.0.0
 */
class timelinemotekef4 extends \Elementor\Widget_Base {
 
   public function get_name() {
      return 'timelinemotekef4';
   }
 
   public function get_title() {
      return esc_html__( 'time line 4', 'timeline-simple-Elementor' );
   }
   ...
   $this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} #motekef4 p' => 'border-color:{{VALUE}}',
				],
				'default' =>'#0013FF'
			]
		);
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} #motekef4 p' => 'color: {{VALUE}}',
				],
				'default' =>'#666666'
			]
		);
	...
	$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}  #motekef4 p' => 'text-align:{{VALUE}}',
				],
				'default' => 'left',
  ...
  protected function render( $instance = [] ) {
    ...
    ?>
	<div id="motekef4" <?php $this->print_render_attribute_string( 'list' ); ?>>
<?php 
